...
static void ViewE_720_init_sequence(struct mipi_dsi_device *dsi) {
	 panel_command(dsi,
						0x7A,
						0xC1);
	  ...
	  panel_command(dsi,
		...
		panel_command(dsi,					
						0x11,
						0x88);//88);SPI_WriteData(90 );SPI_WriteData(98
		panel_command(dsi,					
						0xB6,
						0x20);
		panel_command(dsi,					
...
static void Second_020_init_sequence(struct mipi_dsi_device *dsi) {
...
static const struct drm_display_mode ViewE_720_mode = {
    .clock = 18000,

    .hdisplay = 800,
    .hsync_start = 800 + /* HFP */ 40,
    .hsync_end = 800 + 40 + /* HSync */ 30 ,
    .htotal = 800 + 40 + 30  + /* HBP */ 88,

    .vdisplay = 480,
    .vsync_start = 480 + /* VFP */ 13 ,
    .vsync_end = 480 + 13   + /* VSync */3,
    .vtotal = 480 + 13   + 3 + /* VBP */ 32,
...
static const struct drm_display_mode Second_020_mode = {
    .clock = 18000,
...
static const struct dsi_panel_desc ViewE_720_desc = {
    .mode = &ViewE_720_mode,
    .lanes = 2,
    .flags =
        MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST | MIPI_DSI_MODE_LPM,
    .format = MIPI_DSI_FMT_RGB888,
    .init_sequence = ViewE_720_init_sequence};

static const struct dsi_panel_desc Second_020_desc = {
    .mode = &Second_020_mode,
    .lanes = 2,
    .flags =
        MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST | MIPI_DSI_MODE_LPM,
    .format = MIPI_DSI_FMT_RGB888,
    .init_sequence = Second_020_init_sequence};
...
static const struct of_device_id dsi_panel_of_match[] = {
    {.compatible = "ViewE,ViewE_720", .data = &ViewE_720_desc},
    {.compatible = "ViewE,Second_020", .data = &Second_020_desc},
    {}};
